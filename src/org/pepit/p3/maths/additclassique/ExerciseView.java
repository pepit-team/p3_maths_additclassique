...
public class ExerciseView {
	...
	org.pepit.plugin.Message.display(this._ctx, "MAUVAISE REPONSE",
		Color.RED, this._textSize);
    }
	...
	org.pepit.plugin.Message.display(this._ctx, "OPERATION REUSSIE",
		Color.GREEN, this._textSize);
    }
